...
/**
 * This class defines the structure of the 'photo_comments' table.
 *
 *
...
class PhotoCommentTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.PhotoCommentTableMap';
	...
	{
	  // attributes
		$this->setName('photo_comments');
		$this->setPhpName('PhotoComment');
		$this->setClassname('PhotoComment');
