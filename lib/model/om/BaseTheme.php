...
/**
 * Base class that represents a row from the 'themes' table.
 *
 * 
 *
...
abstract class BaseTheme extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the current_photo_numbers field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $current_photo_numbers;
	...
	/**
	 * Get the [current_photo_numbers] column value.
	 * 
	 * @return     int
	 */
	public function getCurrentPhotoNumbers()
	{
		return $this->current_photo_numbers;
	}
	...
	public function setClassName($v)
	{
		...
		if ($this->class_name !== $v) {
			$this->class_name = $v;
			$this->modifiedColumns[] = ThemePeer::CLASS_NAME;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = ThemePeer::IS_ACTIVE;
		}
	...
	/**
	 * Set the value of [current_photo_numbers] column.
	 * 
	 * @param      int $v new value
	 * @return     Theme The current object (for fluent API support)
	 */
	public function setCurrentPhotoNumbers($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->current_photo_numbers !== $v || $this->isNew()) {
			$this->current_photo_numbers = $v;
			$this->modifiedColumns[] = ThemePeer::CURRENT_PHOTO_NUMBERS;
		}

		return $this;
	} // setCurrentPhotoNumbers()
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->current_photo_numbers !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->current_photo_numbers = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				return $this->getCurrentPhotoNumbers();
				break;
			case 6:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getCurrentPhotoNumbers(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				$this->setCurrentPhotoNumbers($value);
				break;
			case 6:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setCurrentPhotoNumbers($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ThemePeer::CLASS_NAME)) $criteria->add(ThemePeer::CLASS_NAME, $this->class_name);
		if ($this->isColumnModified(ThemePeer::DESCRIPTION)) $criteria->add(ThemePeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(ThemePeer::IS_ACTIVE)) $criteria->add(ThemePeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(ThemePeer::CURRENT_PHOTO_NUMBERS)) $criteria->add(ThemePeer::CURRENT_PHOTO_NUMBERS, $this->current_photo_numbers);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCurrentPhotoNumbers($this->current_photo_numbers);
	 ...
	 * Otherwise if this Theme has previously been saved, it will retrieve
	 * related Photos from storage. If this Theme is new, it will return
		...
		if ($this->collPhotos === null) {
			if ($this->isNew()) {
			   $this->collPhotos = array();
				...
				$criteria->add(PhotoPeer::THEME_ID, $this->id);
	...
	public function countPhotos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collPhotos === null) {
			if ($this->isNew()) {
				...
				$count = PhotoPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Theme has previously been saved, it will retrieve
	 * related ThemeWeathers from storage. If this Theme is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collThemeWeathers === null) {
			if ($this->isNew()) {
			   $this->collThemeWeathers = array();
				...
				$criteria->add(ThemeWeatherPeer::THEME_ID, $this->id);
	 ...
	 */
	public function getThemeWeathersJoinWeather($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ThemePeer::DATABASE_NAME);
		}
		...
		if ($this->collThemeWeathers === null) {
			if ($this->isNew()) {
				...
				$this->collThemeWeathers = ThemeWeatherPeer::doSelectJoinWeather($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
