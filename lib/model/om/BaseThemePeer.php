...
/**
 * Base static class for performing query and update operations on the 'themes' table.
 *
 * 
 *
...
abstract class BaseThemePeer {
	...
	const CLASS_NAME = 'themes.CLASS_NAME';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'themes.DESCRIPTION';

	/** the column name for the IS_ACTIVE field */
	const IS_ACTIVE = 'themes.IS_ACTIVE';

	/** the column name for the CURRENT_PHOTO_NUMBERS field */
	const CURRENT_PHOTO_NUMBERS = 'themes.CURRENT_PHOTO_NUMBERS';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'themes.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'themes.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'ClassName', 'Description', 'IsActive', 'CurrentPhotoNumbers', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'className', 'description', 'isActive', 'currentPhotoNumbers', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::CLASS_NAME, self::DESCRIPTION, self::IS_ACTIVE, self::CURRENT_PHOTO_NUMBERS, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'class_name', 'description', 'is_active', 'current_photo_numbers', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'ClassName' => 2, 'Description' => 3, 'IsActive' => 4, 'CurrentPhotoNumbers' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'className' => 2, 'description' => 3, 'isActive' => 4, 'currentPhotoNumbers' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::CLASS_NAME => 2, self::DESCRIPTION => 3, self::IS_ACTIVE => 4, self::CURRENT_PHOTO_NUMBERS => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'class_name' => 2, 'description' => 3, 'is_active' => 4, 'current_photo_numbers' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ThemePeer::CLASS_NAME);
		$criteria->addSelectColumn(ThemePeer::DESCRIPTION);
		$criteria->addSelectColumn(ThemePeer::IS_ACTIVE);
		$criteria->addSelectColumn(ThemePeer::CURRENT_PHOTO_NUMBERS);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to themes
	...
	/**
	 * Method to DELETE all rows from the themes table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += ThemePeer::doOnDeleteCascade(new Criteria(ThemePeer::DATABASE_NAME), $con);
			ThemePeer::doOnDeleteSetNull(new Criteria(ThemePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += ThemePeer::doOnDeleteCascade($criteria, $con);
			ThemePeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(ThemeWeatherPeer::THEME_ID, $obj->getId());
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related Photo rows to NULL
			$selectCriteria = new Criteria(ThemePeer::DATABASE_NAME);
			$updateValues = new Criteria(ThemePeer::DATABASE_NAME);
			$selectCriteria->add(PhotoPeer::THEME_ID, $obj->getId());
			$updateValues->add(PhotoPeer::THEME_ID, null);
